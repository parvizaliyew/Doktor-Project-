...
class FrontController extends Controller
{
    public function index()
    {
        ...
        return view('front.pages.index',compact('sliders','index_seo','services','about','sers','questions'));
    }
    ...
    {
        $about=DoctorAbout::first();
        return view('front.pages.elaqe',compact('about'));
    }
    public function contact_post(Request $request)
    {
        $email = "eliyevperviz466@gmail.com";
        $title= 'Janna saytindan mesaj var';
